...
pub(super) struct TransactionState {
    ...
    pub(super) offset_map: ImmutableMap<u32, u64>,
...
impl TransactionState {
    ...
    pub(super) fn new(ty: TransactionType, offset_map: ImmutableMap<u32, u64>, frame_count: u32, db_file_size: u64) -> TransactionState {
        TransactionState {
            ty,
            offset_map,
            frame_count,
